...
| Léxico   | Noção | Impacto | Sinônimo | Classificação |
| ------   | ----- | ------- | -------- | ------------- |
|Assinatura|Contrato de assinatura com a Disney+ para usufruir dos conteúdos presentes na plataforma.|O usuário escolhe qual plano de assinatura ele deseja. <br />O usuário poderá usufrir os recursos presentes na plataforma da Disney+ após a assinatura.|Contrato  |Objeto|

### L03 - Assistir

| Léxico | Noção | Impacto | Sinônimo | Classificação |
| ------ | ----- | ------- | -------- | ------------- |
|Assistir|Assistir títulos na Disney+.|Com uma assinatura ativa, dispositivo compatível, acesso a internet ou título baixado, o usuário poderá assistir um título da Disney+.</br>O usuário pode assistir filmes, séries ou documentários.|Ver       | Verbo         |

### L04 - Conta

| Léxico | Noção | Impacto | Sinônimo | Classificação |
| ------ | ----- | ------- | -------- | ------------- |
|Conta   |Local onde o usuário tem acesso as funcionalidades da Disney+ e perfis daquela conta.|O usuário entra na conta para ter acesso aos recursos da Disney+.</br> O usuário pode alterar o email e a senha vinculados aquela conta.</br>O usuário pode visualizar e alterar a sua assinatura.</br>O usuário pode restringir a criação de perfis.|-         | Objeto        |
...
| Léxico | Noção | Impacto | Sinônimo | Classificação |
| ------ | ----- | ------- | -------- | ------------- |
|Excluir |É possível excluir uma conta, perfil ou lista.|O usuário poderá excluir sua conta da Disney+. </br> O usuário poderá excluir um perfil dentro de uma conta da Disney+.</br> O usuário poderá excluir uma lista criada em um perfil da Disney+.|Deletar   | Verbo         |
